...
export const sectionBgConfigs: Record<string, Record<DeviceType, {
    ...
    hero: {
        sm: {
            ...
            planet: planet({ width: 415, height: 415, right: -76.02, top: 100.02, background: MOBILE_PLANET, transform: "matrix(-1, -0.05, -0.05, 1, 0, 0)" }),
        },
        md: {
            redSpot: red({ left: -114.32, top: "60vh", transform: "rotate(-112.47deg)" }),
            blueSpot: blue({ left: 70.83, top: -556.99, transform: "rotate(-124.02deg)" }),
            planet: planet({ width: 615, height: 615, right: -76.02, top: 100.02, background: MOBILE_PLANET, transform: "matrix(-1, -0.05, -0.05, 1, 0, 0)" }),
        },
        lg: {
            ...
            planet: planet({ width: 515, height: 515, right: -96.02, top: 320.02, transform: "matrix(-1, -0.05, -0.05, 1, 0, 0)" }),
        },
        xl: {
            ...
            planet: planet({ width: 615, height: 615, right: -96.02, top: 120.02, transform: "matrix(-1, -0.05, -0.05, 1, 0, 0)" }),
        },
        "2xl": {
    ...
    staticButtonsSection: {
        sm: {
            ...
            planet: planet({ width: 415, height: 415, right: -80.91, top: 125, background: MOBILE_PLANET, transform: "matrix(-1, 0.04, 0.04, 1, 0, 0)", filter: "brightness(90%)" }),
        },
        md: {
            ...
            planet: planet({ width: 715, height: 715, right: -76.02, top: 100.02, background: MOBILE_PLANET, transform: "matrix(-1, -0.05, -0.05, 1, 0, 0)" }),
        },
        lg: {
            ...
            planet: planet({ width: 615, height: 615, right: -96.02, top: 220.02, transform: "matrix(-1, -0.05, -0.05, 1, 0, 0)" }),
        },
        xl: {
            ...
            planet: planet({ width: 715, height: 715, right: -70.91, top: 25, transform: "matrix(-1, 0.04, 0.04, 1, 0, 0)" }),
        },
        "2xl": {
    ...
    integrated: {
        sm: {
            ...
            blueSpot: blue({ left: 551.82, top: -383.87, transform: "rotate(-82.13deg)" }),
            planet: planet({ width: 415, height: 415, right: -80.91, top: 35, background: MOBILE_PLANET, transform: "matrix(-1, 0.04, 0.04, 1, 0, 0)", filter: "brightness(90%)" }),
        },
        md: {
            ...
            planet: planet({ width: 615, height: 615, right: -86.02, top: 50.02, background: MOBILE_PLANET, transform: "matrix(-1, -0.05, -0.05, 1, 0, 0)" }),
        },
        lg: {
            ...
            planet: planet({ width: 615, height: 615, right: -96.02, top: 10.02, transform: "matrix(-1, -0.05, -0.05, 1, 0, 0)" }),
        },
        xl: {
            redSpot: red({ width: 300, height: 400, left: "20vw", top: "40vh", transform: "rotate(-46.26deg)" }),
            blueSpot: blue({ left: 100.83, top: -656.99, transform: "rotate(-61.68deg)" }),
