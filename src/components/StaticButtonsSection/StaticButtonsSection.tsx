            ...
            {show && (
                ...
                >
                    {staticButtons.map(({title, description}) => (
                        ...
                        >
                            <span
                                className="font-inter text-4xl lg:text-5xl xl:text-6xl font-bold text-white">{title}</span>
                            <span
                                className="font-inter text-base md:text-md lg:text-xl font-normal text-gray-300 mt-2">{description}</span>
                        </div>
                    ))}
                </motion.div>
            )}
